...
namespace Test {
	TestGBuffer::TestGBuffer()
		:m_Cube(), m_CubeShader("res/Shaders/TestGBuffer/base.shader"), m_CubeTexture("res/Textures/container.png"),
		m_Screen(2.0f, 2.0f), m_ScreenShader("res/Shaders/TestGBuffer/gbuffer.shader")
	{
	...
	void TestGBuffer::OnUpdate(float delta_time)
	{
	}

	void TestGBuffer::OnRender()
	{
	...
	void TestGBuffer::OnImGuiRender()
	{
	}
}
