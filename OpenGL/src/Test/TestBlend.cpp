...
namespace Test {
	TestBlend::TestBlend()
		:m_Cube(), m_Window_1(), m_Window_2(), m_Shader("res/Shaders/TestBlend/base.shader"),
		m_CubeTex("res/Textures/container.png"), m_WindowTex("res/Textures/blending_transparent_window.png")
	{
	...
	void TestBlend::OnUpdate(float delta_time)
	{
