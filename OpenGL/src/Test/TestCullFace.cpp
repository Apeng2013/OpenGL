...
namespace Test {
	TestCullFace::TestCullFace()
		...
		m_Shader("res/Shaders/TestCullFace/base.shader"), m_Texture("res/Textures/container.png")
	{
	...
	void TestCullFace::OnImGuiRender()
	{
	}
}